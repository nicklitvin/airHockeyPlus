...
import Lobby from "./lobbyExperiment.js"
import Game1Manager from "./gameManagerExperiment.js"
...
export default class RoomManager{
    ...
    setUpGameManagers(io){
        new Game1Manager(io,this.lobbies,this.users,this.socks)
    }
    ...
    isLobbyOpen(lobbyId){
        if(this.doesLobbyExist(lobbyId)){
            if(!this.getLobbyInfo(lobbyId).inGame){
                return(true)
            }
        }
    }
    ...
    createLobby(socket=0){
        ...
        this.lobbies[lobbyId] = new Lobby(this.users,this.socks,lobbyId)
